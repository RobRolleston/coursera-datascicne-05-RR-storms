...
```
The remaining exponenent notation were all converted to numerical values, along with the true alue of the damage.
```{r}
...
```
Now that all the values share a common format, the rows can be aggreageted by `EVTYPE`, with sums, sorted, and the top 10 of each selected
```{r}
